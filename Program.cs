...
namespace TEST
{
    ...
    class program
    {
        ...
        static void Main()
        {
            ...
            {
                Console.WriteLine("{0} \n {1}", property.PropertyType.Name, property.Name);
            }
            Console.WriteLine("Methods in Customers Class");
            MethodInfo[] methods = T.GetMethods();
            foreach(MethodInfo method in methods)
            {
                Console.WriteLine("Methods Return Type:{0} && Method Name:{1}",method.ReturnType.Name,method.Name);
            }
            Console.WriteLine();
            Console.WriteLine("Constructors in Customers Class");
            ConstructorInfo[] cc = T.GetConstructors();
            foreach(ConstructorInfo constructor in cc)
            {
                Console.WriteLine("Constructor Name{0} \n Constructor String{1}", constructor.Name, constructor.ToString);
            }
        }
    ...
    public class Video53
    {
        public int ID { get; set; }
        public string Name { get; set; }
        public Video53(int ID, string Name)
        {
            this.ID = ID;
            this.Name = Name;
